...
import { MarketplaceOrderService } from './gen/wargapos/marketplace_order/v1/service_pb'
...
export const marketplaceOrderClient = createClient(MarketplaceOrderService, transport)
